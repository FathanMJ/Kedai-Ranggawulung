...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="../admin/assets/img/icons/logo.jpeg">
    <link rel="icon" type="image/png" sizes="16x16" href="../admin/assets/img/icons/logo.jpeg">
