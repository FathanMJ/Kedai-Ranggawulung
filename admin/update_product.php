...
if (isset($_POST['UpdateProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price']) || empty($_POST['prod_stock'])) {
    ...
    // Bind parameters
    $rc = $postStmt->bind_param('ssssssi', $prod_code, $prod_name, $prod_img, $prod_desc, $prod_price, $prod_stock, $update);
    $postStmt->execute();
                ...
                <form method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-row">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="number" name="prod_price" min="0" class="form-control" value="<?php echo $prod->prod_price; ?>">
                    </div>
                    <div class="col-md-6">
                      <label>Product Stock</label>
                      <input type="number" name="prod_stock" min="0" class="form-control" value="<?php echo $prod->prod_stock; ?>">
                    </div>
                  </div>
                  <hr>
                  <div class="form-row">
