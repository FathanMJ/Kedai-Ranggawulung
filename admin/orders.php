                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td>
                        <a href="make_oder.php?prod_id=<?php echo $prod->prod_id; ?>&prod_name=<?php echo $prod->prod_name; ?>&prod_stock=<?php echo $prod->prod_stock; ?>&prod_price=<?php echo $prod->prod_price; ?>">
