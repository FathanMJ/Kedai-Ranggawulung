    ...
    if (empty($_POST["pay_code"]) || empty($_POST["pay_method"])) {
        ...
        if (!$orderRow) {
            ...
            if ($token) {
                ...
                $err = "Failed to create payment token. Please check your Midtrans configuration.";
            }
        } else {
            // Handle traditional payment methods (Cash, Paypal, etc.)
            $order_status = "Paid";
            $pay_id = isset($payid) ? $payid : uniqid('PAY-');
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <label>Payment Code (Proof/Reference)</label>
                                        <input type="text" name="pay_code" placeholder="e.g., Transfer Receipt Number" class="form-control" required>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" readonly value="<?php echo $order_code; ?>" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Customer Name</label>
                                        <input type="text" readonly value="<?php echo $row->customer_name; ?>" class="form-control">
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control" name="pay_method" id="pay_method" required>
                                            ...
                                            <option value="Midtrans">Midtrans (Card, Bank Transfer, E-Wallet)</option>
                                        </select>
                                    </div>
                                </div>
                                <br>
                                
                                <div class="alert alert-info" id="payment_info" style="display: none;">
                                    <strong>Payment Information:</strong>
                                    <ul>
                                        <li><strong>Cash:</strong> Manual payment recording</li>
                                        <li><strong>Paypal:</strong> Manual payment recording</li>
                                        <li><strong>Midtrans:</strong> Secure online payment (Credit Card, Bank Transfer, E-Wallet, etc.)</li>
                                    </ul>
                                </div>
                                
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="submit" name="pay" value="Proceed to Payment" class="btn btn-success btn-block">
                                    </div>
                                    <div class="col-md-6">
                                        <a href="payments.php" class="btn btn-outline-secondary btn-block">Cancel</a>
                                    </div>
                                </div>
                            </form>
                        </div>
